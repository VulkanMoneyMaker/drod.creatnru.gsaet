...
public class ButtonItems extends CCMenu
{
	private float scaleFactor;
	public ButtonItems(CCMenuItem...items)
	{
		super(items);
	...
	public static ButtonItems button(String normalImage, String selectImage, CCNode target, String sel, int index)
	{
		...
		menuItem.setTag(index);
		Custom_R.setScale(menuItem, true);
		//Button menu = new Button(menuItem);
		return new ButtonItems(menuItem);
	}
