...
import spoty.game.machine.view_layer.ResultPlayGame;
import spoty.game.machine.R;

public class Custom_R {
	public static Vector<ResultPlayGame> TGameResult = new Vector<ResultPlayGame>();
